...
import { AwsAuth, ClusterLoggingTypes, EndpointAccess, KubernetesManifest, KubernetesPatch } from 'aws-cdk-lib/aws-eks';
...
export class Kube10kCluster extends Construct {
  ...
  constructor(scope: cdk.Stack, id: string, props: Kube10kClusterProps) {
     ...
     */
    const layerPath = Code.fromAsset('assets/kubectl-layer').path;
     ...
     */
    const kubeProxyVersionPatch = new KubernetesPatch(this, 'KubeProxyVersionPatch', {
      cluster: this.cluster,
